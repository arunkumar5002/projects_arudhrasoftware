<?php
class Attendance_import_model extends CI_Model{
	...
	public function __construct() {
		...
		$this->column_order = array(
            ...
            '5'=>'tbl_attendance_master.attend_over_time',
            '6'=>'tbl_attendance_master.attend_total_hours',
            '7'=>'tbl_attendance_master.attend_status',
        );
    ...
    public function countAll($postData){
		...
		if(!empty($postData['emp_id'])){
			$this->db->where('employee.employee_id',$postData['emp_id']);
		}
		
		if(!empty($postData['attend_month_year'])){
			$this->db->where('tbl_attendance_master.attend_month_year',$postData['attend_month_year']);
		}
