								...
								<div class="">
									<h3>
										...
										<span style="float:right;">
											...
											<a class="btn btn-success " style="cursor:pointer" href="<?php echo base_url() ?>Hr/month_attendence">Month Attendance</a>
											<a class="btn btn-success " style="cursor:pointer" href="<?php echo base_url() ?>Hr/daily_attendence">Daily Attendance</a>
								...
								<div class="x_panel">
									...
									<div class="x_content">
										...
										<style>
											...
											.halfday {
												color: #fff;
												background-color: rgb(252, 169, 0);
											}
