...
<?php  $vouchertypelist = array('1'=>"PV",'2'=>"RV",'3'=>"JV",'4'=>"CV");							
						...
						?>
							...
							<table width='100%' border=1  align=center style="border-collapse: collapse;border:2px solid #000 !important; "  cellpadding=10>
								<tr>
									<th>S.No</th>
									<th>Date</th>
									<th>V Type</th>
								...
								?>
									<tr>
										...
										<td width="2%" style="font-size:16px"><?php echo date("d-m-y",strtotime($temp->voucherdate));?></td>
										<td width='2%'>&nbsp;<?php if(isset($temp->vouchertype) && !empty($temp->vouchertype)) { echo $vouchertypelist[$temp->vouchertype]; }  ?></td>
										<td width='2%'>&nbsp;<?php echo $temp->voucherno;?></td>
										<td width='5%'>&nbsp;
										<?php 
											if($temp->debit != '0.00')
												$s = 'By';
