  ...
  <body onLoad="myFunction()">
            <div class="right_col" role="main">
                <div class="" style="margin-left: 300px;" >
					...
					<div class="title_left" style="width:70%;text-align:center;">
						<u>
							<h2 ><span style="color:green; font-size:22px; !important"><?php echo get_defaultcompany()?></span></h2>
						
							<h3 style="font-size:18px; !important" >Profit & Loss for the financial year ended <span style="color:green"><?php echo date("d-M-Y",strtotime(get_defaultyear_end()));?></span></h3>
						...
						<tr height="50px">
							...
							<span style="align:left "><?php echo get_currency(); ?></span>
							</td>
						</tr>
						</table>
		...
		<?php
						...
						echo "<table  width='70%' border='1px;'>";	
						unset($bArr);
						...
						<tr>
							...
							<td width='70%' align='right' ><label style='color:#000' >&nbsp;&nbsp;
							<?php
						...
						<tr height='50px'>
							...
							<td width='70%' style='<?php if($grossprofit > 0) { ?>color:green; <?php }else { ?> color:red; <?php } ?>  font-weight:bold' align='right'>&nbsp;
						...
						<tr height='30px'>
							<td width="70%" ><label style="color:brown;" >&nbsp;<?php echo get_accountname($key)?> </label></td>
							<td  align='right'  ><label style="color:brown;" >&nbsp;
							<?php
						...
						<tr height='50px'>
							...
							<td width='70%' style='<?php if($indirect > abs($net)) { ?>color:green; <?php }else { ?> color:red; <?php } ?> font-weight:bold' align='right'>&nbsp;
							<?php
