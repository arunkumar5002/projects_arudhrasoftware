 <!-- page content -->
            <div class="right_col" role="main">
                ...
                View Purchase Invoice
                       ...
                       <span style='float:right;' class='btn btn-primary'><a href='<?php echo base_url()?>accounts/invoices' style='color:white'>Back</a></span>
                    </div>
							...
							<div class='col-md-12 col-sm-12 col-xs-12'>
                                  <br>
                                       ...
                                       <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-4" for="customername">GRN <span class="required">*</span>
                                            </label>
                                            <div class="col-md-8 col-sm-8 col-xs-8">
												<?php echo $invoice->grnnumber?$invoice->grnnumber:"-";?>
                                            </div>
                                        </div>
