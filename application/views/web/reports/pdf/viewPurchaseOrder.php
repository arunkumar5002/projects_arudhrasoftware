 <!-- page content -->
            <div class="right_col" role="main">
                ...
                View Purchase Order
                       ...
                       <span style='float:right;' class='btn btn-primary'><a href='<?php echo base_url()?>accounts/orders' style='color:white'>Back</a></span>
                    </div>
                                  ...
                                  <br>
										<div class="form-group col-md-4 col-sm-4 col-xs-4">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-8">
                                               <?php echo $order->purchaseordernum ?>
                                            </div>
                                        </div>	
                                       ...
                                       <div class="form-group col-md-4 col-sm-4 col-xs-4">
                                        ...
                                        <div class="form-group col-md-4 col-sm-4 col-xs-4">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-8">
                                                  <?php echo get_contactname($order->supplier) ?>
                                            </div>
                                        </div>
                                        </div>
