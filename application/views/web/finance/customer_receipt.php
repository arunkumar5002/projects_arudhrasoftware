					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<a href="<?= base_url().'salesvoucher' ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> New</a>
								
								<button type="button" id="" class="btn btn-info btn-sm editvoucher"><i class="fas fa-edit"></i> Edit</button>
								
								<button type="button" id="" class="btn btn-info btn-sm deletevoucher"><i class="fas fa-trash"></i> Delete</button>
								
								<button type="button" id="" class="btn btn-info btn-sm printvoucher"><i class="fas fa-print"></i> Print</button>
...
<!---Add1-->
    ...
    <style>
		...
		"serverSide": true,
		"ajax": {
			"url": "<?php echo base_url() ?>web/ajaxsalesinvoice",
			"type": "POST",
                ...
                $(".editvoucher").click(function(){
				     if($(".voucherid").is(":checked")){
						  if($(".voucherid:checked").length == 1){
							  ...
							  window.location.href = "<?php echo base_url()?>accounts/salesvoucher/"+id[1];  
						  }else{
                ...
                $(".deletevoucher").click(function(){
				     if($(".voucherid").is(":checked")){
							...
							$(".voucherid:checked").each(function(){
							  ...
							  if(e)
							  window.location.href = "<?php echo base_url()?>accounts/salesdeleteVoucher/"+ids;  
