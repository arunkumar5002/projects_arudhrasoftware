            ...
            <div class="row" style="margin-bottom:1.5rem!important;">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="<?= base_url().'department_master' ?>">Department Master</a></li>
                    </ol>
                </div>
            </div>
			<div class="row">
					...
					<div class="card">
						<div class="card-header p-2">
							<ul class="nav nav-pills">
								<li class="nav-item"><a class="nav-link active" href="#timeline" data-toggle="tab">Department Category</a></li>
							</ul>
						</div>
						<div class="card-body">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control form-control-sm" name="department_name" id="department_name" required />
														</div>
													</div>
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<select class="form-control form-control-sm" name="department_status" id="department_status" required>
